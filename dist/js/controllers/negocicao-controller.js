...
export class NegocicacaoController {
    constructor() {
        ...
        this.negociacoesView = new NegociacoesView("#negocicoesView");
...
__decorate([
    domInjector("#data")
], NegocicacaoController.prototype, "inputData", void 0);
__decorate([
    domInjector("#quantidade")
], NegocicacaoController.prototype, "inputQuantidade", void 0);
__decorate([
    domInjector("#valor")
], NegocicacaoController.prototype, "inputValor", void 0);
__decorate([
    logarTempoDeExecucao(),
    inspect()
], NegocicacaoController.prototype, "adiciona", null);
